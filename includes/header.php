...
<style>
    ...
    .account-menu {
        ...
        background: #fff;
        border-radius: 16px;
        box-shadow: 0 20px 40px rgba(14, 35, 18, 0.16);
        padding: 0.5rem;
        z-index: 1050;
    }
...
<header class="main-header">
    ...
    <nav class="main-nav" id="mainNav">
        ...
        <a href="../pages/complaints.php">Feedback</a>
        <?php if ($logged_in): ?>
            <?php if ($role === 'admin'): ?>
                <a href="../Admin/admin.php"><i class="fas fa-shield-alt"></i> Admin</a>
                <a href="../Admin/view_orders.php"><i class="fas fa-shopping-cart"></i> Orders</a>
            <?php endif; ?>
            <div class="nav-actions">
                <a class="cart-link" href="../pages/cart.php">
                ...
                <div class="account-dropdown">
                    ...
                    <div class="account-menu">
                        <a href="../pages/profile.php"><i class="fas fa-id-card"></i> Profile</a>
                        <a href="../pages/profile.php#edit-profile"><i class="fas fa-pen-to-square"></i> Edit Profile</a>
                        <a href="../pages/logout.php"><i class="fas fa-right-from-bracket"></i> Logout</a>
                    </div>
                </div>
            </div>
        <?php else: ?>
