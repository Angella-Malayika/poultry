                        ...
                        <form action="process_complaint.php" method="POST">
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="tel" class="form-control" name="phone" inputmode="numeric" maxlength="10" pattern="[0-9]{10}" title="Phone number must be 10 digits">
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label">Order ID (optional)</label>
                                    <input type="text" class="form-control" name="order_id" placeholder="Example: 125">
                                </div>
                                <div class="col-12">
