...
function ensure_photo_schema($conn, &$columns)
{
    ...
    if (!in_array('product_section', $columns, true)) {
        if (!mysqli_query($conn, "ALTER TABLE photos ADD COLUMN product_section VARCHAR(40) NOT NULL DEFAULT 'broilers'")) {
            return 'Unable to add product_section column in photos table.';
        }
        ...
        <div class="p-4">
            <div class="card hero mb-4">
                <div class="card-body p-4 position-relative">
                    ...
                    <p class="mb-0 text-white-50">Choose where each upload should appear on the Products page: Broilers, Layers, Animal Feeds, or One-Day-Old Chicks.</p>
                </div>
            </div>
                    ...
                    <div class="card upload-card">
                        <div class="card-body p-4">
                            ...
                            <form method="POST" enctype="multipart/form-data">
                                <div class="mb-3">
                                    <label for="product_section" class="form-label fw-semibold">Add This Image To</label>
                                    <select id="product_section" name="product_section" class="form-select" required>
                                        <option value="">Select section</option>
                                        <?php foreach ($upload_sections as $section_key => $section_label): ?>
                                            <option value="<?php echo htmlspecialchars($section_key); ?>" <?php echo $selected_section === $section_key ? 'selected' : ''; ?>>
                                    ...
                                    <div class="col-6">
                                        <div class="recent-photo">
                                            ...
                                            <div class="recent-meta">
                                                ...
                                                <?php
                                                $recent_section_key = (string) ($photo['product_section'] ?? '');
