<?php
// Admin/upload_photo.php – Add / Edit product form (no product list)
...
$categories = [];
$edit_product_id = 0;
$is_editing = false;  // <-- INITIALIZED HERE
...
<div class="row">
    ...
    <div class="col-md-9 col-lg-10 p-0">
        <div class="top-bar d-flex justify-content-between align-items-center">
            <div>
                <h5 class="mb-0"><?php echo $is_editing ? 'Edit Product' : 'Add Product'; ?></h5>
                <small class="text-muted"><?php echo $is_editing ? 'Update product details' : 'New products saved here appear on customer pages.'; ?></small>
            </div>
        ...
        <div class="p-4 p-lg-5">
            <?php if ($message !== ''): ?>
                <div class="alert alert-<?php echo htmlspecialchars($message_type); ?> shadow-sm"><?php echo htmlspecialchars($message); ?></div>
            <?php endif; ?>
