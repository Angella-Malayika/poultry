<?php 
// pages/contact.php – Fixed paths using BASE_URL from config.php
...
<body>
    ...
    <section id="contact" class="contact-section">
        <div class="container">
            ...
            <?php
            // Display success/error messages from session (set by process_message.php)
            ...
            <div class="row g-4">
                ...
                <div class="col-md-6">
                    <div class="contact-form card p-3">
                        ...
                        <form action="<?php echo BASE_URL; ?>/process_message.php" method="POST" id="messageForm">
                            <div class="mb-3">
