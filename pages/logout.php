<?php
// pages/logout.php – Fixed paths using BASE_URL from config.php
...
<body>
    <div class="logout-container">
        ...
        <div class="logout-footer">
            <small>Need help? <a href="<?php echo BASE_URL; ?>/pages/contact.php">Contact our support team</a></small>
        </div>
    </div>
